...
def NewVideo(url=str, desc=str, posted_by=str):
    ...
    if user == None:
        log2term(
            'E',
            f"Video can't be added to database since user {posted_by} doesn't exist"
        )
        return None
...
def AddView(username=str, video_id=int):
    ...
    session.commit()
    session.close()
    return user_stats.views, video.views
...
if __name__ == '__main__':
    if new_db == True:
        ...
        NewUser('ist186412', 'filipe.reynaud@tecnico.ulisboa.pt',
                'Filipe Reynaud')
        NewUser('ist187612', 'miguel.de.matos.e.sa@tecnico.ulisboa.pt',
                'Miguel Sá')
        ...
        NewVideo('https://www.youtube.com/watch?v=II5UsqP2JAk',
                 'The Last of Us Part II – Release Date Reveal Trailer | PS4',
                 'ist426524')
        NewVideo('https://www.youtube.com/watch?v=iqysmS4lxwQ&ab_channel=IGN',
        ...
        NewVideo('https://www.youtube.com/watch?v=cBoPbdOaw7M&ab_channel=IGN',
